...
const IMAGE_MODELS = [
  ...
  { value: "GeminiImageNode:gemini-2.5-flash-image", label: "Gemini 2.5 Flash" },
  { value: "GeminiImage2Node:gemini-3-pro-image-preview", label: "Gemini 3 Pro" },
  { value: "GeminiNanoBanana2:Nano Banana 2 (Gemini 3.1 Flash Image)", label: "Nano Banana 2 (Gemini 3.1 Flash)" },
  { value: "GoogleImagenNode:imagen-4.0-generate-preview-06-06", label: "Imagen 4" },
  { value: "GoogleImagenNode:imagen-3.0-generate-002", label: "Imagen 3" },
...
const VIDEO_MODELS = [
  ...
  { value: "KlingOmniProTextToVideoNode:kling-v3-omni", label: "Kling 3 T2V", hasAudio: true },
  { value: "KlingOmniProImageToVideoNode:kling-video-o1", label: "Kling Video O1", hasAudio: false },
  { value: "KlingTextToVideoWithAudio:kling-v2-6", label: "Kling v2.6 + Audio", hasAudio: true },
  { value: "KlingImageToVideoWithAudio:kling-v2-6", label: "Kling v2.6 I2V + Audio", hasAudio: true },
  ...
  { value: "Veo3VideoGenerationNode:veo-3.1-fast-generate", label: "Veo 3.1 Fast", hasAudio: true },
  { value: "Veo3VideoGenerationNode:veo-3.0-generate-001", label: "Veo 3.0", hasAudio: true },
  { value: "VeoVideoGenerationNode:veo-2.0-generate-001", label: "Veo 2", hasAudio: false },
