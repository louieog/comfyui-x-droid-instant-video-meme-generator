...
- Native audio video models: Veo3VideoGenerationNode, KlingTextToVideoWithAudio, KlingImageToVideoWithAudio, KlingOmniProTextToVideoNode, KlingOmniProImageToVideoNode, WanSoundImageToVideo
